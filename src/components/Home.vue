<template>
	<div id="home">
		<header>
			<i><img src="../assets/home/header/H_r2_c1.png"/></i>
			<div class="search">
			...
			<div class="r">
				<ul>
					<li><span><img src="../assets/home/header/H_r1_c3.png" alt="" /></span><a href="">我的店铺</a></li>
					<li><span><img src="../assets/home/header/H_r1_c5.png"/></span><a href="">消息</a></li>
				</ul>
			</div>
	</header>
		<div class="main" @scroll="flag && scrollFn()">
			<div class="scroll-top">
				<v-banner :data="data"></v-banner>
				<nav>
					<ul v-for="(i,index) in data.nav" :key="index"> 
						<li v-for="(v,index) in i" :key="index">
				...
				<div class="tip">
					...
					<div class="swiper">
						<div class="swiper-wrapper">
							<div class="swiper-slide" v-for="(x,index) in data.tip" :key="index">
								<div class="tip-r">
									{{x}}
								</div>
							</div>
				...
				<div class="list">
					...
					<div class="shop">
						<v-goods @Fn="successFn"  v-for="(i,index) in shop" :shopData="i" :key="index"></v-goods>
					</div>
				</div>
			</div>
		</div>
		<v-footer></v-footer>
		<v-tip v-if="success"></v-tip>
	</div>
</template>
<script>
